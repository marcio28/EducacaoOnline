...
namespace EducacaoOnline.GestaoConteudo.Domain.Validators
{
    ...
    {
        public static string ConteudoObrigatorioErroMsg => "O conteúdo da aula é obrigatório.";
        ...
        public static string TituloObrigatorioErroMsg => "O título é obrigatório.";
        ...
        public AulaValidator()
        {
            ...
            RuleFor(a => a.Titulo)
                .NotNull().WithMessage(TituloObrigatorioErroMsg);

            RuleFor(a => a.Titulo)
                .Length(2, 100).WithMessage(TamanhoTituloErroMsg);

            RuleFor(a => a.Conteudo)
                .NotNull().WithMessage(ConteudoObrigatorioErroMsg);
